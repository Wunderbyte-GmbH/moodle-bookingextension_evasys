...
/**
 * Adhoc Task for EvaSys to open survey for data collection.
 *
 ...
 */
class evasys_open_survey extends \core\task\adhoc_task {
    /**
     * Get task name.
     *
    ...
    public function get_name() {
        return get_string('opensurvey', 'bookingextension_evasys');
    }
        ...
        if ($taskdata != null) {
            ...
            try {
                ...
                if (is_object($taskdata->surveyid)) {
                        mtrace('Invalid surveyid in task data. Survey was not opened. The data is: ' . json_encode($taskdata));
                        return;
                }
