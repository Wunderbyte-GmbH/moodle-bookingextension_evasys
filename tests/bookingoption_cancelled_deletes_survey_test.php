...
/**
 * Tests that cancelling a booking option deletes its survey in EvaSys.
 *
 ...
 * Tests that cancelling a booking option deletes its survey in EvaSys.
 */
final class bookingoption_cancelled_deletes_survey_test extends advanced_testcase {
    /**
     * Tests set up.
     *
     * @return void
    ...
    private function create_option_setup(): array {
        ...
        $booking = $this->getDataGenerator()->create_module('booking', [
            'name' => 'EvaSys Cancellation Case',
            'eventtype' => 'Cancellation test',
        ...
        $record->description = 'Cancellation test option';
    ...
    /**
     * Creates a survey for the option via the edit option form, then cancels the
     * option and checks that survey and course are gone in the EvaSys API.
     *
     * @covers \bookingextension_evasys\observer::bookingoption_cancelled
     ...
     * @return void
     */
    public function test_bookingoption_cancelled_deletes_survey_in_evasys(): void {
        global $DB;
        ...
        $postdata = (object) [
            ...
            'description' => 'Cancellation test option',
            'evasys_form' => 510,
        ...
        // Cancel the booking option like the UI does; this triggers the
        // bookingoption_cancelled event which the observer reacts to.
        booking_option::cancelbookingoption($option->id, 'Cancelled in test');
