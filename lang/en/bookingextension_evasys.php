...
$string['evaluationdurationafterend'] = 'End of evaluation period (hours after end of event)';
$string['evaluationdurationbeforestart'] = 'Start of evaluation period (hours before end of event)';
...
$string['evasysdescription'] = 'Evaluations will only be created once dates have been added, trainers have been assigned and all fields have been filled in after selecting the questionnaire';
...
$string['evasysperiods_desc'] = 'Select the Semester used for EvaSys.';
$string['evasysqrcode'] = 'We look forward to your feedback!';
$string['evasysqrcode_col'] = 'QR-Code Download evasys Evaluation';
...
$string['notifyparticipants'] = 'Should an optional notification with a call for evaluation be sent to all participants at the end of the event? If yes, please check the box.';
...
$string['sendreportforpastsurveys'] = 'Send reports for all past surveys';
$string['sendreportforpastsurveys_desc'] = 'Manually trigger sending reports for all EvaSys entries that have a survey ID and an end time in the past.';
$string['sendreportforpastsurveys_result'] = 'Processed {$a->total} past surveys. Reports sent: {$a->sent}. Failed: {$a->failed}.';
