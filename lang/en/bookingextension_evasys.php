...
$string['evasysdescription'] = 'Evaluations are only created once trainers have been assigned and all fields have been filled in after selecting the questionnaire.';
