...
$string['evaluationactive'] = 'Evaluierung kann nicht gelöscht werden, da sie bereits läuft ist';
$string['evaluationdurationafterend'] = 'Ende des Evaluierungszeitraums (Stunden nach Veranstaltungsende)';
$string['evaluationdurationbeforestart'] = 'Beginn des Evaluierungszeitraums (Stunden vor Veranstaltungsende)';
...
$string['evasysdescription'] = 'Evaluierungen werden erst angelegt, wenn Daten hinzugefügt wurden, Trainer*innen festgelegt wurden und alle Felder nach Auswahl des Fragebogens befüllt wurden';
...
$string['evasysqrcode_col'] = 'QR-Code Download evasys Evaluierung';
...
$string['evasyswarning'] = '<div class="alert alert-danger" role="alert">Notiz für Admins: Alle Anforderungen für eine Umfrage sind erfüllt, es wurde aber keine in evasys angelegt. Bitte an Wunderbyte wenden.</div>';
...
$string['notifyparticipants'] = 'Soll zum Veranstaltungsende eine optionale Benachrichtigung mit Aufruf zur Evaluierung an alle Teilnehmer*innen verschickt werden? Wenn ja, bitte Checkbox ankreuzen';
$string['opensurvey'] = 'bookingextension_evays: open survey for data collection (adhoc task)';
$string['otherreportrecipients'] = 'Weitere Berichtsempfänger*innen';
...
$string['sendreportforpastsurveys'] = 'Berichte für alle vergangenen Umfragen senden';
$string['sendreportforpastsurveys_desc'] = 'Versendet Berichte manuell für alle EvaSys-Einträge mit vorhandener Umfrage-ID und einem Endzeitpunkt in der Vergangenheit.';
$string['sendreportforpastsurveys_result'] = '{$a->total} vergangene Umfragen verarbeitet. Berichte gesendet: {$a->sent}. Fehlgeschlagen: {$a->failed}.';
